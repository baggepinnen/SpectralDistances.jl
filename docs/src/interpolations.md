...
for t = LinRange(0, 1, 7)
    ...
    plot!(w, sqrt.(Φ), xscale=:log10, yscale=:log10, line_z = t, lab="", xlabel="Frequency", title=L"W_2", ylims=(1e-3, 1e1), colorbar=false, l=(1,), c=:viridis)
end
...
for t = LinRange(0, 1, 7)
    Φ = interp(w,t)
    plot!(w, sqrt.(Φ), xscale=:log10, yscale=:log10, line_z = t, lab="", xlabel="", title=L"RD", ylims=(1e-3, 1e1), colorbar=false, l=(1,), c=:viridis)
end
